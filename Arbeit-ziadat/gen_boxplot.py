...
data_invers = read_csv_data( CSV_FILENAME, "invers.topo.sh")

data_all = [data_joint, data_weights, data_invers]
...
print("POURIA Median: ", statistics.median(data_invers))
print("POURIA Minimum: ", min(data_invers))
print("POURIA Maximum: ", max(data_invers))